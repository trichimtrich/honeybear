      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/engine/object"><i class="fa fa-circle"></i> Objects</a></li>
...
<div class="box box-warning">
            <div class="box-header with-border"><i class="fa fa-tripadvisor"></i>
              ...
              <dl class="dl-horizontal">
                ...
                {{else}}
                  {{range .Queries}}
                    ...
                    <dd>
                      {{range .Tokens}}
                      (<span class="text-red">{{.Token}}</span>-{{.Content}})
                      {{end}}
                    </dd>
                    {{end}}
                  {{end}}
