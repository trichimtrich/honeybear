...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/engine/snapshot"><i class="fa fa-circle"></i> Profile Control</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Web Profiles
        <small>BearEngine</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">BearEngine</a></li>
        <li class="active">Profile Control</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          ...
          <div class="pull-right">Total: {{len .}}</div>
        </div>
        <table id="containerTable" class="table table-bordered table-hover">
          <thead>
            ...
            <tr>
              <td>
              {{if eq .id .curID}}
                <input type="radio" name="r1" id={{.id}} class="minimal" checked>
              {{else}}
                <input type="radio" name="r1" id={{.id}} class="minimal">
              {{end}}
              </td>
              <td>{{.name}}</td>
              <td>{{.desc}}</td>
  ...
  <!-- zzz -->
    ...
    <form class="box box-primary" action="" method="post">
            ...
            <div class="box-body">
              ...
              <!-- Date and time range -->
              <div class="form-group">
                <label>Date range - Learning phase:</label>

                <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-clock-o"></i>
                  </div>
                  <input type="text" class="form-control pull-right" name="learn" id="learnTime">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <!-- Date and time range -->
              <div class="form-group">
                <label>Date range - Verifying phase:</label>

                <div class="input-group">
                  <div class="input-group-addon">
                    <i class="fa fa-clock-o"></i>
                  </div>
                  <input type="text" class="form-control pull-right" name="verify" id="verifyTime">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
