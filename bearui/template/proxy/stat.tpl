      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="/proxy/stat"><i class="fa fa-circle"></i> Proxy Stat</a></li>
...
$(function () {
  ...
  function updateMemory() {
    $.ajax({
      method: "GET",
      url: "/proxy/stat/live?p=quicklook",
      success: function (data) {
