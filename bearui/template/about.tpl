    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="/help/about"><i class="fa fa-circle"></i> About Us</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row"  style="text-align: center">
          <h1 class="headline"><b>HoneyBear</b> <i class="fa fa-paw"></i></h1>
          <img src="/static/dist/img/bear.png" style="border:5px solid #000">
          

          <div class="error-content">
            <h3><i class="fa fa-steam"></i> Team</h3>
        ...
        <div class="row">
          <div class="col-md-2 col-md-offset-4">
            <img class="profile-user-img img-responsive img-circle" src="/static/dist/img/tri.jpg">
            <h3 class="profile-username text-center">Tri Dang Minh</h3>
            <p class="text-muted text-center">Security Engineer</p>
          </div>

          <div class="col-md-2">
            <img class="profile-user-img img-responsive img-circle" src="/static/dist/img/sang.jpg">
            <h3 class="profile-username text-center">Sang Pham Minh</h3>
            <p class="text-muted text-center">Security Engineer</p>
          </div>
        </div>
